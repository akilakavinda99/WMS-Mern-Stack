...
import './Header.css';
import {LabourHeaderData} from './LabourHeaderData'
...
return(
  //mapping and creating rows
    <div className="SideBar">
      ...
      <button className="btn btn-danger" id="buttonthusal" onClick={onClickLogoutHandler}>logout</button>
      {LabourHeaderData.map((val,key)=>{
        return(
          <li  className="row"
